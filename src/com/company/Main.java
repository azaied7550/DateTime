...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        DateTimeFormatter longFormat1 = DateTimeFormatter.ofPattern("MMM dd yyyy");
        DateTimeFormatter longFormatDay = DateTimeFormatter.ofPattern("EEEE MM yyyy");
        ...
        System.out.println("Date format: day, Month (3 letters) and year (4 digit)          : "+userDate.format(shortMonthFormat));
        System.out.println("Date format: Month(3 letters), day  and year (4 digit)          : "+userDate.format(longFormat1));
        System.out.println("Date format: day, month (2 digits) and year  (4 digit)          : "+userDate.format(dTF));
        System.out.println("Date format: day(letters), month (2 digits) and year(4 digit)   : "+userDate.format(longFormatDay));
